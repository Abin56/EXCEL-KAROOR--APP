...
import 'package:excel_karror/model/student_model/data_base_model.dart';
import 'package:excel_karror/view/constant/sizes/sizes.dart';
import 'package:excel_karror/view/pages/chat/teacher_section/student_message/chats/students_chats.dart';
...
class SearchStudentsForChat extends SearchDelegate {
  TeacherChatController teacherChatController =
      Get.put(TeacherChatController());
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if (query.isEmpty) {
      buildSuggestionList = teacherChatController.searchStudents;
    } else {
      buildSuggestionList = teacherChatController.searchStudents
          .where((item) =>
