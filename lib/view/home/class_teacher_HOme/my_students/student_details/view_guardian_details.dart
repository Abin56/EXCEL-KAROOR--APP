                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        TextWidget(
                                          text:
                                              'Student Name : ${snapshot.data!.docs[0]['guardianName']}',
                                        ),
                                      ],
                                    ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        TextWidget(
                                          text:
                                              'Guardian Phone Number : ${snapshot.data!.docs[0]['guardianPhoneNumber']}',
                                        ),
                                      ],
                                    ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        TextWidget(
                                          text:
                                              'Guardian Email : ${snapshot.data!.docs[0]['guardianEmail']}',
                                        ),
                                      ],
                                    ),
