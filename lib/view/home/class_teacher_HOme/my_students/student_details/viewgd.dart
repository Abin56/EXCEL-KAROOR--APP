...
import 'package:excel_karror/view/home/class_teacher_HOme/my_students/student_details/view_students_details.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: adminePrimayColor,
          title:
              GooglePoppinsWidgets(text: 'Guardian Details'.tr, fontsize: 18.w),
        ),
        body: (widget.documentSnapshot == null)
            ? Center(
                child: GoogleMonstserratWidgets(
                text: 'Guardian Details not available'.tr,
                fontsize: 14.w,
              ))
            : ListView(
                children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextWidget(
                                        text:
                                            'Student Name : ${widget.documentSnapshot!['guardianName']}',
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextWidget(
                                        text:
                                            'Parent Phone Number : ${widget.documentSnapshot!['guardianPhoneNumber']}',
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextWidget(
                                        text:
                                            'Parent Email : ${widget.documentSnapshot!['guardianEmail']}',
                                      ),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      TextWidget(
                                        text:
                                            'Place: ${widget.documentSnapshot!['place']}',
                                      ),
                                    ],
                                  ),
                          ...
                          Container(
                            ...
                            child: CircleAvatar(
                              ...
                              backgroundImage: NetworkImage(
                                  '${widget.documentSnapshot!['profileImageURL']}'),
                            ),
                          ),
                        ],
                      ),
