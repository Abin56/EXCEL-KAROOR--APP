...
import 'package:excel_karror/view/pages/progress_Report/view_report/all_students.dart';
...
class ViewExamsForProgressreport extends StatelessWidget {
  ...
  const ViewExamsForProgressreport(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                     Navigator.push(context, MaterialPageRoute(builder: (context) {
                                      return ViewAllStudentsListScreen(
                                        schooilID: schooilID,
                                        classID: classID,
                                    ...
                                    // Get.off(() => ViewAllStudentsListScreen(
                                    //     schooilID: schooilID,
                                    //     classID: classID,
                                    //     examName: snapshot.data?.docs[index]
                                    //             ['docid'] ??
